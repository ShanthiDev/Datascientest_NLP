...
NLP Project of Datascientest Cohort Aug 2024 (supply chain group): Extract and track topics and sentiments in news articles over time across different media outlets and countries. Predict how coverage evolves over time (frequency, sentiment)

# Project: Topic Extraction and Trend Analysis Across Media and Countries
